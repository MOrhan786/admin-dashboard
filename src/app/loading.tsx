        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="flex space-x-3 mt-8">
            {[...Array(3)].map((_, i) => (
              <div 
                key={i}
                className="w-4 h-4 rounded-full bg-gradient-to-br from-blue-500 to-green-500 animate-pulse"
                style={{
          ...
          <div className="w-64 h-1.5 bg-gray-800 rounded-full mt-6 overflow-hidden">
            <div className="w-1/2 h-full bg-gradient-to-r from-blue-500 to-green-500 animate-progress" />
          </div>
        </div>
      </div>
    )
